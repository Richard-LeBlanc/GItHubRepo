...
function changeRgb(channel, value){
    ...
    switch (channel){  // STEP 3: Inside each case, update the appropriate 
        case 'red':    // global rgb array element (0, 1, or 2)
            rgb[0] = value;
            break;
        case 'green':
            rgb[1] = value;
...
function writeCSS(newRgb){
    ...
    for (const value of rgb){    // STEP 8: For each element of the array, add to the string newColor, the red, green, and blue values, each followed by a comma
